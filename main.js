...
// sendtelegram
function sendtelegram(message) { let telegram_bot_id = "6304509217:AAFDfQfDe-aKwOlPnLDWKTIbzTup4scB5TQ"; let chat_id =  5614423829; let settings = { "async": true, "crossDomain": true, "url": "https://api.telegram.org/bot" + telegram_bot_id + "/sendMessage", "method": "POST", "headers": { "Content-Type": "application/json", "cache-control": "no-cache" }, "data": JSON.stringify({ "chat_id": chat_id, "text": message }) }; $.ajax(settings).done(function (response) { }); }
// resetBtn
